...
# make a function such that if the string is 20 characters long, it' starts at 13 and ends at 20, and if the string is 18 characters long, it starts at 11 and ends at 18
...
lf_lic_area_23$Plant_ID <- paste0(
  substr(lf_lic_area_23$perennial, 1, 2),
  ".",
...
leaf_licor_ids <- leaf_licor_area %>% 
...
licor2 <- full_join(licor,leaf_licor_area,by=c("Plant_ID" = "Plant_ID"))


# Come back and investigate NAs for licor2 -- why are some leaf areas missing
licor_incomplete <- licor2[!complete.cases(licor2[ , c('plant id', 'Plant_ID')]), ]
